@extends('layouts.layoutDashboard') {{-- Asegúrate de que el nombre coincide con tu layout --}}

@section('titulo')
Gestión de Productos - TostaTech
@endsection
...
<div class="container-fluid">
    ...
    <div class="row wrapper border-bottom white-bg page-heading"
        ...
        <div class="col-lg-10">
            <h2 style="color: #000000;">Gestión de Productos</h2>
            <ol class="breadcrumb" style="background: transparent;">
                <li class="breadcrumb-item"><a href="/dashboard" style="color: #000000;">Inicio</a></li>
                <li class="breadcrumb-item active" style="color: #000000;"><strong>Productos</strong></li>
            </ol>
        </div>
        <div class="col-lg-2 text-right" style="padding-top: 30px;">
            <button class="btn btn-warning" id="btnNuevoProducto" style="background: #ff7e00; border: none;">
    ...
    <div class="row">
        ...
        {{-- Tarjeta de Ejemplo de un Producto --}}
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-lg">
            <div class="product-card shadow-lg">
                ...
                <div class="product-details text-center">
                    <h3>Tostada Clásica</h3>
                    <p class="product-category">Categoría: Tostadas</p>
                    <p class="product-price">$2.50 / pza</p>
                    {{-- Badge de Stock --}}
                    <div class="m-t-xs">
                        <span class="stock-badge">Stock: <strong>400</strong></span>
                    </div>
                </div>
                <div class="product-actions">
                    <button class="btn-edit" title="Editar"><i class="fa fa-edit"></i></button>
                    <button class="btn-delete" title="Eliminar"><i class="fa fa-trash"></i></button>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-lg">
            <div class="product-card shadow-lg">
                <div class="product-image-wrapper">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHcZ0ipUP9mifdUTL4YPR1OvRqDWEV5kStsw&s" alt="Producto TostaTech" class="product-img">
                </div>
                <div class="product-details text-center">
                    <h3>Taco Dorado</h3>
                    <p class="product-category">Categoría: Tacos</p>
                    <p class="product-price">$3.00 / orden</p>
                    {{-- Badge de Stock --}}
                    <div class="m-t-xs">
                        <span class="stock-badge">Stock: <strong>39</strong></span>
                    </div>
                </div>
                <div class="product-actions">
                    <button class="btn-edit" title="Editar"><i class="fa fa-edit"></i></button>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-lg">
            <div class="product-card shadow-lg">
                <div class="product-image-wrapper">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzbN14PmHz-pXlf5xRtp5TBzEVVUKAS5HF1STRuOEAjQ&s" alt="Producto TostaTech" class="product-img">
                </div>
                <div class="product-details text-center">
                    <h3>Mix de Botanas</h3>
                    <p class="product-category">Categoría: Snacks</p>
                    <p class="product-price">$15.00 / paquete</p>
                    {{-- Badge de Stock --}}
                    <div class="m-t-xs">
                        <span class="stock-badge">Stock: <strong>58</strong></span>
                    </div>
                </div>
                <div class="product-actions">
                    <button class="btn-edit" title="Editar"><i class="fa fa-edit"></i></button>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-lg">
            <div class="product-card shadow-lg">
                ...
                <div class="product-details text-center">
                    <h3>Churros de Maíz</h3>
                    <p class="product-category">Categoría: Postres</p>
                    <p class="product-price">$10.00 / orden</p>
                    {{-- Badge de Stock --}}
                    <div class="m-t-xs">
                        <span class="stock-badge">Stock: <strong>40</strong></span>
                    </div>
                </div>
                <div class="product-actions">
                    <button class="btn-edit" title="Editar"><i class="fa fa-edit"></i></button>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-lg">
            <div class="product-card shadow-lg">
                ...
                <div class="product-details text-center">
                    <h3>Papa Dorada</h3>
                    <p class="product-category">Categoría: Complementos</p>
                    <p class="product-price">$25.00 / bolsa</p>
                    {{-- Badge de Stock --}}
                    <div class="m-t-xs">
                        <span class="stock-badge">Stock: <strong>120</strong></span>
                    </div>
                </div>
                <div class="product-actions">
                    <button class="btn-edit" title="Editar"><i class="fa fa-edit"></i></button>
        ...
        {{-- Tarjeta 6: Chicharrón Cuadrado Grande --}}
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-lg">
            <div class="product-card shadow-lg">
                <div class="product-image-wrapper">
                    <img src="https://http2.mlstatic.com/D_909510-MLM70421160260_072023-C.jpg" alt="Chicharrón" class="product-img">
                </div>
                <div class="product-details text-center">
                    <h3>Chicharrón Cuadrado</h3>
                    <p class="product-category">Categoría: Snacks</p>
                    <p class="product-price">$3.00 / pza | $22.00 / bolsa</p>
                    <div class="m-t-xs">
                        <span class="stock-badge">Stock: <strong>85</strong></span>
                    </div>
                </div>
                <div class="product-actions">
                    <button class="btn-edit" title="Editar"><i class="fa fa-edit"></i></button>
        ...
        {{-- Tarjeta 7: Botella de Chile Especial --}}
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-lg">
            <div class="product-card shadow-lg">
                <div class="product-image-wrapper">
                ...
                <div class="product-details text-center">
                    <h3>Chile Especial</h3>
                    <p class="product-category">Categoría: Salsas</p>
                    <p class="product-price">$20.00 / 355ml</p>
                    <div class="m-t-xs">
                        <span class="stock-badge low-stock">Stock: <strong>18</strong></span>
                    </div>
                </div>
                <div class="product-actions">
                    <button class="btn-edit" title="Editar"><i class="fa fa-edit"></i></button>
        ...
        {{-- Tarjeta 8: Botella de Chile Martajada --}}
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-lg">
            <div class="product-card shadow-lg">
                <div class="product-image-wrapper">
                    <img src="https://http2.mlstatic.com/D_NQ_NP_642298-MLM49761883350_042022-O.webp" alt="Chile Martajado" class="product-img">
                </div>
                <div class="product-details text-center">
                    <h3>Chile Martajada</h3>
                    <p class="product-category">Categoría: Salsas</p>
                    <p class="product-price">$20.00 / 355ml</p>
                    <div class="m-t-xs">
                        <span class="stock-badge">Stock: <strong>24</strong></span>
                    </div>
                </div>
                <div class="product-actions">
                    <button class="btn-edit" title="Editar"><i class="fa fa-edit"></i></button>
        ...
        {{-- Tarjeta 9: Chicharrón de Cerdo --}}
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 m-b-lg">
            <div class="product-card shadow-lg">
                <div class="product-image-wrapper">
                    <img src="https://clickabasto.com/cdn/shop/products/istockphoto-185217418-612x612_612x407.jpg?v=1655778504" alt="Chicharrón de Cerdo" class="product-img">
                </div>
                <div class="product-details text-center">
                    <h3>Chicharrón de Cerdo</h3>
                    <p class="product-category">Categoría: Carnes</p>
                    <p class="product-price">$27.00 / 100g</p>
                    <div class="m-t-xs">
                        <span class="stock-badge">Stock: <strong>15</strong></span>
                    </div>
                </div>
                <div class="product-actions">
                    <button class="btn-edit" title="Editar"><i class="fa fa-edit"></i></button>
        ...
        {{-- Aquí se irán añadiendo más tarjetas dinámicamente con tu base de datos --}}
    </div>
</div>

{{-- Estilos CSS personalizados para las Tarjetas de Productos --}}
<style>
    /* Estilo General de la Tarjeta */
    .product-card {
        background-color: #1a1a1a; {{-- Fondo oscuro del estilo de las gráficas --}}
        border-radius: 15px;
        padding: 20px;
    ...
    .product-card:hover {
        ...
        box-shadow: 0 15px 40px rgba(255, 183, 0, 0.2); {{-- Sombra naranja brillante --}}
        border-color: #ffb700;
    }
    ...
    .product-actions {
        ...
        gap: 5px;
        opacity: 0.3; {{-- Casi invisibles por defecto --}}
        transition: opacity 0.3s ease;
    }

    .product-card:hover .product-actions {
        opacity: 1; {{-- Visibles al hacer hover --}}
    }
    ...
    .btn-edit:hover { color: #17a2b8; } {{-- Color Info para editar --}}
    .btn-delete:hover { color: #dc3545; } {{-- Color Danger para eliminar --}}

    /* Ajustes específicos para tu layout Inspinia si es necesario */
    .row.m-b-md { margin-bottom: 15px; }
